...
<body tyle="background-color: lightblue; padding: 20px;">
<!-- fOOD sEARCH Section Starts Here -->
<section class="food-search text-center">
    <div class="container">
        <form action="<?php echo SITEURL; ?>food-search.php" method="POST"> <!-- Changed to a PHP file for processing -->
...
<section class="food-menu">
    <div class="container">
        ...
        <?php
        $sql2 = "SELECT * FROM tbl_food WHERE active='Yes' AND feature='Yes' LIMIT 4"; // Corrected to select from tbl_food
